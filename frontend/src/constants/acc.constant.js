...
export const ACC_ENDPOINTS = {
  ACC_LOGIN: `${accBaseUrl}/authentication/v2/authorize?response_type=code&client_id=${accClientId}&redirect_uri=${redirectUri}&scope=data:read data:write account:read`,
  ACC_TOKEN: `${accBaseUrl}/authentication/v2/token`,
  ACC_ME: `${accBaseUrl}/userprofile/v1/users/@me`,  // dont provide accBaseUrl because of cors
  ACC_TEMPLATE_FORMS: `${accBaseUrl}/construction/forms/v1/projects/${projectId}/form-templates`,
